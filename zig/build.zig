...
pub fn build(b: *Build) void {
    ...
    const part = b.option(u8, "part", "part 1 or part 2") orelse 0;
    const use_test_data = b.option(bool, "test", "use test data") orelse false;

    const options = b.addOptions();
    options.addOption(u8, "part", part);
    options.addOption(bool, "use_test_data", use_test_data);
